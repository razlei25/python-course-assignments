...
## Program
This program, **the Israeli local authorities visualizer**, processes and visualizes data about local authorities in Israel. In the example provided, it take the Excel file with data from 2023, `p_libud_23.xlsx`, saved in the `data` folder. It extracts relevant information, filters categories, and generates several statistical plots, saving them as PNG images in the `plots` folder.
